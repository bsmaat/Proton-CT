...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
	...
	G4LogicalVolume* logicTuba = new G4LogicalVolume(tuba, water_mat, "LogicTuba");
	G4LogicalVolume* logicTubb = new G4LogicalVolume(tubb, water_mat, "LogicTubb");
	G4LogicalVolume* logicTubC = new G4LogicalVolume(tubC, water_mat, "LogicTubC");
	G4LogicalVolume* logicTubd = new G4LogicalVolume(tubd, water_mat, "LogicTubd");
	G4LogicalVolume* logicTube = new G4LogicalVolume(tube, water_mat, "LogicTube");
	G4LogicalVolume* logicTubf = new G4LogicalVolume(tubf, water_mat, "LogicTubf");
	G4LogicalVolume* logicTubg = new G4LogicalVolume(tubg, water_mat, "LogicTubg");
	G4LogicalVolume* logicTubh = new G4LogicalVolume(tubh, water_mat, "LogicTubh");
	G4LogicalVolume* logicTubi = new G4LogicalVolume(tubi, water_mat, "LogicTubi");
	G4LogicalVolume* logicTubj = new G4LogicalVolume(tubj, water_mat, "LogicTubj");

	G4LogicalVolume* logicTubesubd = new G4LogicalVolume(tubesubd, water_mat, "LogicTubesubd");
	G4LogicalVolume* logicTubesubdf = new G4LogicalVolume(tubesubdf, water_mat, "LogicTubefsubd");
	G4LogicalVolume* logicTubgsubd = new G4LogicalVolume(tubgsubd, water_mat, "LogicTubgsubd");

	//G4LogicalVolume* logicTubdsube = new G4LogicalVolume(tubdsube, water_mat, "LogicTubdsube");
	G4LogicalVolume* logicTubdsubeg = new G4LogicalVolume(tubdsubeg, water_mat, "LogicTubesubeg");

	G4LogicalVolume* logicTubfsube = new G4LogicalVolume(tubfsube, water_mat, "LogicTubfsube");

	G4LogicalVolume* logicTubintersectde = new G4LogicalVolume(tubintersectde, water_mat, "LogicTubintersectde");
	G4LogicalVolume* logicTubintersectdg = new G4LogicalVolume(tubintersectdg, water_mat, "LogicTubintersectdg");
	G4LogicalVolume* logicTubintersectef = new G4LogicalVolume(tubintersectef, water_mat, "LogicTubintersectef");
	...
	new G4PVPlacement(TubaRot, G4ThreeVector(0, 0, 0), logicTuba, "TubaPhantom", logicEnv, false, 0, checkOverlaps);
